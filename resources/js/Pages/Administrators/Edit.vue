    ...
    <div class="bg-white py-2 sm:py-6">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="px-4 sm:px-6 lg:px-8">
          ...
          <form :action="route('administrators.update', { user: administrator.id })" method="POST" @submit.prevent="submitForm">
...
function submitForm() {
  ...
  if (Object.keys(errors.value).length === 0) {
    ...
    router.put(route('administrators.update', administrator.id), form);
  } else {
